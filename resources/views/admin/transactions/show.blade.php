                ...
                <div class="flex flex-row gap-x-10">
                    ...
                    <div class="flex flex-col gap-y-10">
                        ...
                        @if ($transaction->is_paid)
                            <h3 class="px-3 py-2 text-sm font-bold text-white bg-green-500 rounded-full w-fit">
                                Active
                            </h3>
                        @else
                            <h3 class="px-3 py-2 text-sm font-bold text-white bg-orange-500 rounded-full w-fit">
                                Pending
                            </h3>
                        @endif
                        <div>
                        ...
                        <div>
                            <p class="text-sm text-slate-500">Subscribe Start At</p>
                            <h3 class="text-xl font-bold text-indigo-950">{{ $transaction->subscribe_start_date }}</h3>
                        </div>
                        <div class="">
                    ...
                    <div>
                        <img src="{{ Storage::url($transaction->proof) }}" alt="{{ $transaction->proof }}">
                    </div>
                </div>
                <hr class="my-5">
                @if (!$transaction->is_paid)
