...
<head>
    ...
    <link wire:naigate href="{{ asset('css/output.css') }}" rel="stylesheet">
    <link wire:naigate href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&display=swap"
        rel="stylesheet" />
    <!-- CSS -->
    <link rel="stylesheet" wire:naigate href="https://unpkg.com/flickity@2/dist/flickity.min.css">
    <link rel="stylesheet" wire:naigate href="https://cdn.plyr.io/3.7.8/plyr.css" />
    <link rel="stylesheet" wire:naigate
...
<body class="text-black font-poppins pt-10 pb-[50px]">
    <div style="background-image: url('{{ asset('assets/background/Hero-Banner.png') }}')" id="hero-section"
        ...
        <nav class="flex justify-between items-center pt-6 px-[50px]">
            <a wire:navigate wire:naigate href="index.html">
                <img src="{{ asset('assets/logo/logo.svg') }}" alt="logo">
            </a>
            <ul class="flex items-center gap-[30px] text-white">
                <li>
                    <a wire:navigate wire:naigate href="/" class="font-semibold">Home</a>
                </li>
                <li>
                    <a wire:navigate wire:naigate href="/pricing" class="font-semibold">Pricing</a>
                </li>
                <li>
                    <a wire:navigate wire:naigate href="" class="font-semibold">Benefits</a>
                </li>
                <li>
                    <a wire:navigate wire:naigate href="" class="font-semibold">Stories</a>
                </li>
            </ul>
            @auth
        ...
        <div class="relative flex gap-5 video-player flex-nowrap">
            ...
            <div
                ...
                <div class="flex flex-col gap-3">
                    <a wire:navigate href="{{ route('front.details', $course) }}">
                        <div
                    ...
                    @forelse ($course->course_videos as $video)
                        @php
                            $currentVideo = Route::current()->parameter('courseVideoId');
                            $is_active = $currentVideo == $video->id;
                        @endphp

                        <a wire:navigate
                            href="{{ route('front.learning', [$course, 'courseVideoId' => $video->id]) }}">
                            <div
                                class="{{ $is_active ? 'bg-[#3525B3]' : 'bg-[#E9EFF3]' }} group p-[12px_16px] flex items-center gap-[10px] rounded-full hover:bg-[#3525B3] transition-all duration-300">
                                ...
                                <p
                                    class=" {{ $is_active ? 'text-white' : 'text-black' }} font-semibold transition-all duration-300 group-hover:text-white">
                                    {{ $video->name }}
                                </p>
                            </div>
                        </a>
                        ...
                        <div class="flex flex-col gap-4 p-5 bg-white mentor-info rounded-2xl">
                            ...
                            <div class="flex items-center justify-between w-full">
                                <div class="flex items-center gap-3">
                                    <a wire:navigate wire:naigate href=""
        ...
        <div class="flex justify-between">
            ...
            <div class="flex flex-col gap-5">
                ...
                <ul class="flex flex-col gap-[14px]">
                    <li>
                        <a wire:navigate wire:naigate href="" class="text-[#6D7786]">Online Courses</a>
                    </li>
                    <li>
                        <a wire:navigate wire:naigate href="" class="text-[#6D7786]">Career Guidance</a>
                    </li>
                    <li>
                        <a wire:navigate wire:naigate href="" class="text-[#6D7786]">Expert Handbook</a>
                    </li>
                    <li>
                        <a wire:navigate wire:naigate href="" class="text-[#6D7786]">Interview Simulations</a>
                    </li>
                </ul>
            </div>
            <div class="flex flex-col gap-5">
                ...
                <ul class="flex flex-col gap-[14px]">
                    <li>
                        <a wire:navigate wire:naigate href="" class="text-[#6D7786]">About Us</a>
                    </li>
                    <li>
                        <a wire:navigate wire:naigate href="" class="text-[#6D7786]">Media Press</a>
                    </li>
                    <li class="flex items-center gap-[10px]">
                        <a wire:navigate wire:naigate href="" class="text-[#6D7786]">Careers</a>
                        <div
                    ...
                    <li>
                        <a wire:navigate wire:naigate href="" class="text-[#6D7786]">Developer APIs</a>
                    </li>
                </ul>
            </div>
            <div class="flex flex-col gap-5">
                ...
                <ul class="flex flex-col gap-[14px]">
                    <li>
                        <a wire:navigate wire:naigate href="" class="text-[#6D7786]">Blog</a>
                    </li>
                    <li>
                        <a wire:navigate wire:naigate href="" class="text-[#6D7786]">FAQ</a>
                    </li>
                    <li>
                        <a wire:navigate wire:naigate href="" class="text-[#6D7786]">Help Center</a>
                    </li>
                    <li>
                        <a wire:navigate wire:naigate href="" class="text-[#6D7786]">Terms & Conditions</a>
                    </li>
                </ul>
            </div>
        </div>
