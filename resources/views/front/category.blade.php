...
<head>
    ...
    <link wire:navigate href="{{ asset('css/output.css') }}" rel="stylesheet">
    <link wire:navigate href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&display=swap"
        rel="stylesheet" />
    @livewireStyles
    @livewireScripts
</head>
    ...
    <div style="background-image: url('{{ asset('assets/background/Hero-Banner.png') }}')" id="hero-section"
        ...
        <nav class="flex justify-between items-center pt-6 px-[50px]">
            ...
            <ul class="flex items-center gap-[30px] text-white">
                <li>
                    <a wire:navigate href="/" class="font-semibold">Home</a>
                </li>
                <li>
                    <a wire:navigate href="/pricing" class="font-semibold">Pricing</a>
                </li>
                <li>
                    <a wire:navigate href="" class="font-semibold">Benefits</a>
                </li>
                <li>
                    <a wire:navigate href="" class="font-semibold">Stories</a>
                </li>
            </ul>
                    ...
                    <div class="course-card">
                        <div
                            ...
                            <a href="{{ route('front.details', $course->slug) }}"
                                ...
                                <img src="{{ Storage::url($course->thumbnail) }}" class="object-cover w-full h-full"
                                    alt="thumbnail" loading="lazy">
                            </a>
                            <div class="flex flex-col px-4 gap-[32px]">
                                <div class="flex flex-col gap-[10px]">
                                    <a wire:navigate href="details.html"
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <p class="text-[#6D7786]">{{ $course->teacher->user->occuption }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div
                    ...
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        <div class="flex items-center gap-3">
                            <div class="flex w-8 h-8 overflow-hidden rounded-full shrink-0">
                                <img src="{{ asset('assets/photo/photo4.png') }}" class="object-cover w-full h-full"
                                    alt="photo">
                            </div>
        ...
        <div class="flex justify-between">
            ...
            <div class="flex flex-col gap-5">
                ...
                <ul class="flex flex-col gap-[14px]">
                    <li>
                        <a wire:navigate href="" class="text-[#6D7786]">Online Courses</a>
                    </li>
                    <li>
                        <a wire:navigate href="" class="text-[#6D7786]">Career Guidance</a>
                    </li>
                    <li>
                        <a wire:navigate href="" class="text-[#6D7786]">Expert Handbook</a>
                    </li>
                    <li>
                        <a wire:navigate href="" class="text-[#6D7786]">Interview Simulations</a>
                    </li>
                </ul>
            </div>
            <div class="flex flex-col gap-5">
                ...
                <ul class="flex flex-col gap-[14px]">
                    <li>
                        <a wire:navigate href="" class="text-[#6D7786]">About Us</a>
                    </li>
                    <li>
                        <a wire:navigate href="" class="text-[#6D7786]">Media Press</a>
                    </li>
                    <li class="flex items-center gap-[10px]">
                        <a wire:navigate href="" class="text-[#6D7786]">Careers</a>
                        <div
                    ...
                    <li>
                        <a wire:navigate href="" class="text-[#6D7786]">Developer APIs</a>
                    </li>
                </ul>
            </div>
            <div class="flex flex-col gap-5">
                ...
                <ul class="flex flex-col gap-[14px]">
                    <li>
                        <a wire:navigate href="" class="text-[#6D7786]">Blog</a>
                    </li>
                    <li>
                        <a wire:navigate href="" class="text-[#6D7786]">FAQ</a>
                    </li>
                    <li>
                        <a wire:navigate href="" class="text-[#6D7786]">Help Center</a>
                    </li>
                    <li>
                        <a wire:navigate href="" class="text-[#6D7786]">Terms & Conditions</a>
                    </li>
                </ul>
            </div>
        </div>
