    ...
    <div id="checkout-section"
        ...
        <div class="flex gap-10 px-[100px] relative z-10">
            <div class="w-[400px] flex shrink-0 flex-col bg-white rounded-2xl p-5 gap-4 h-fit">
                <p class="text-lg font-bold">Package</p>
                <div class="flex items-center justify-between w-full">
                    <div class="flex items-center gap-3">
                        <div class="w-[50px] h-[50px] flex shrink-0 rounded-full overflow-hidden">
                            <img src="assets/icon/Web Development 1.svg" class="object-cover w-full h-full"
                                alt="photo">
                        </div>
                ...
                <div class="flex flex-col gap-5">
                    <div class="flex gap-3">
                        <div class="flex w-6 h-6 shrink-0">
                            <img src="assets/icon/tick-circle.svg" class="object-cover w-full h-full" alt="icon">
                        </div>
            ...
            <form action="{{ route('front.checkout.store') }}" method="POST"
                class="flex flex-col w-full gap-5 p-5 bg-white rounded-2xl" enctype="multipart/form-data">
                @csrf
                <p class="text-lg font-bold">Send Payment</p>
                <div class="flex flex-col gap-5">
                ...
                <hr>
                <p class="text-lg font-bold">Confirm Your Payment</p>
                <div class="relative">
                    <button type="button"
        ...
        <div class="absolute bottom-0 flex justify-center w-full transform -translate-x-1/2 left-1/2">
